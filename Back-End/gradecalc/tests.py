"""
NOTE:
This test file is kept for future use.
Current API format changed to support component-based grading.
Tests below refer to old structure and are disabled for now.
"""
